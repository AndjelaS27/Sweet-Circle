...
export default function ChocolateStrawberry(props) {
  const { nodes, materials } = useGLTF('/models/chocolateStrawberry.glb');
...
useGLTF.preload('/models/chocolateStrawberry.glb');
