...
export default function StrawberryStrawberry(props) {
  const { nodes, materials } = useGLTF('/models/strawberryStrawberry.glb');
...
useGLTF.preload('/models/strawberryStrawberry.glb');
