...
export default function ChocolateChocolate(props) {
  const { nodes, materials } = useGLTF('/models/chocolateChocolate.glb');
...
useGLTF.preload('/models/chocolateChocolate.glb');
